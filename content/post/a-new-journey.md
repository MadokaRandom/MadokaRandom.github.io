---
title: "新的旅程"
lastmod: 2021-04-14T16:13:24+08:00
tags: ["Posts", "回归", "模板", "配置"]
categories: ["杂项"]
draft: true
weight: 1
...
这一节单独列出来是因为它比数学公式还要难处理，根据 `ox-hugo`[^fn:4] 的说明，现在有三种引用图片的方法：
...
[^fn:3]: <https://orgmode.org/manual/Creating-Footnotes.html>
[^fn:4]: <https://ox-hugo.scripter.co>
[^fn:5]: <https://github.com/Molunerfinn/PicGo>
